...
// binary will be loaded through checkpoint
  ...
  // To populate data memory
  memif.read(0x80000000, mem_size, (void *)top->ariane_testharness__DOT__i_ariane__DOT__ex_stage_i__DOT__lsu_i__DOT__i_ord_sram__DOT__ram);
